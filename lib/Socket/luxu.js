...
class imup {
    ...
    async handlePayment(content, quoted) {
        ...
        async handlePollResult(content, jid, quoted) {
            ...
            if (pollData.newsletter?.newsletterJid && pollData.newsletter?.newsletterName) {
                context = {
                    isForwarded: true,
                    forwardingScore: 1,
                    forwardNewsletterMessageInfo: {
                        newsletterJid: pollData.newsletter.newsletterJid,
        ...
        async handleOrderMessage(content, jid, quoted) {
            const {
                ...
                message = "",
                orderTitle = "",
                totalAmount1000 = null,
                totalCurrencyCode = ""
            } = content.orderMessage;
            
            const Haha = {
                orderId: "7EPPELI-25022008",
                ...
                totalAmount1000: totalAmount1000.totalAmount1000 || 0,
                totalCurrencyCode: totalCurrencyCode.totalCurrencyCode || "XXX",
                messageVersion: 2
            };
            return await this.relayMessage(jid, Haha, {
                userJid: this.utils.generateMessageID().split('@')[0] + '@s.whatsapp.net'
            });
        }
    }
